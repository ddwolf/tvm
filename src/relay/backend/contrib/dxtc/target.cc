 ...
 */
TVM_REGISTER_TARGET_KIND("custom", kDLCPU)
    .set_attr<Bool>("is_device", Bool(false))
    .set_attr<Bool>(tvm::attr::kIsExternalCodegen, Bool(true))
    .set_attr<String>("compiler", String("custom"))
    .set_attr<String>("device_name", String("custom"))
    .set_default_keys({"cpu"})
    .set_attr<String>("device_type", String("custom"));
